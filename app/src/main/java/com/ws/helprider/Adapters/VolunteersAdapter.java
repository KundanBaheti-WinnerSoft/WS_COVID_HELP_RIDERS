...
public class VolunteersAdapter extends RecyclerView.Adapter<VolunteersAdapter.MyViewHolder> {
    ...
    public VolunteersAdapter(Context context, ArrayList<HashMap<String, String>> productname) {
    ...
    @Override
    public VolunteersAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.volunteers_adapter, parent, false);
        return new VolunteersAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final VolunteersAdapter.MyViewHolder holder, final int position) {
        ...
        profileDetails.setUserId(Integer.parseInt(arraymap.get(position).get("userId")));
